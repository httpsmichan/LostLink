    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <NotificationCard
          ...
          title="Claim request receive"
          subtitle="Rei has submitted a claim for the gold rimmed glasses you found at the Comfort Room."
          time="9:15 AM"
          primaryButtonText="View Match"
          secondaryButtonText="Dismiss"
        />
        ...
        <NotificationCard
          ...
          subtitle="We found a blue wallet that might match your lost item. The location is different but other details match."
          time="10:25 AM"
          primaryButtonText="View Match"
          secondaryButtonText="Dismiss"
        />
